package ru.netology.offerairline;
...
public class AviaSoulsTest {
    ...
    Ticket ticket3 = new Ticket("Белореченск", "Майкоп", 10_400, 9, 10);
    Ticket ticket4 = new Ticket("Москва", "Архангельск", 5_600, 10, 12);
    Ticket ticket5 = new Ticket("Ставрополь", "Армавир", 3_750, 4, 7);
    Ticket ticket6 = new Ticket("Белореченск", "Майкоп", 15_450, 15, 17);
    Ticket ticket7 = new Ticket("Бийск", "Белоярский", 9_750, 16, 17);
    Ticket ticket8 = new Ticket("Белореченск", "Майкоп", 16_500, 18, 19);
    ...
    public void functionSearchTestSixth() {
        ...
        Ticket[] actual = aviaSouls.search("Белореченск", "Майкоп");
        Assertions.assertArrayEquals(expected, actual);
    }
    ...
    public void functionSearchAndSortByTestTwelfth() {
        ...
        Ticket[] actual = aviaSouls.searchAndSortBy("Белореченск", "Майкоп", comparator);
        Assertions.assertArrayEquals(expected, actual);
    }
