...
public class Ticket implements Comparable<Ticket> {
    ...
    public int flightTime() {
        int flightTimeFromPointBToPointA;
        if (timeTo > timeFrom) {
            flightTimeFromPointBToPointA = timeTo - timeFrom;
        } else {
            flightTimeFromPointBToPointA = (24 - timeFrom) + timeTo;
        }
        return flightTimeFromPointBToPointA;
    }
}